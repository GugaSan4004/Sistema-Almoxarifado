...
document.addEventListener("DOMContentLoaded", function () {
    fetch("/user-ip", {
        ...
        .then(data => {
            if (["192.168.7.119", "192.168.7.20", "127.0.0.1"].includes(data[0].Message)) {
            ...
            if (["192.168.7.58", "192.168.7.20", "127.0.0.1"].includes(data[0].Message)) {
                            ...
                            if (data[0].type == "returns") {
                                ...
                                getCorrespondences() -
                                    ...
                                    fetch("/mails/update", {
                                        ...
                                        .then(data => {
                                            container.innerHTML = `        
                                <div id="to_almox_button" class="to_almox" ${["192.168.7.58", "192.168.7.20", "127.0.0.1"].includes(data[0].Message) ? "" : "style='display: none'"}>
