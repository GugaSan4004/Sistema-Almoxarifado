...
window.onload = function () {
    if (getCookie('first_login') === 'true') {
        ...
        main.className = "grid bg-white grid-flow-col h-140 w-270 rounded-4xl z-1"
        ...
        form.innerHTML = `
                ...
                type="password">
                <input class="duration-300 transition-colors rounded-sm border border-gray-300 focus:ring-2 focus:ring-default-main 0 bg-gray-200 h-11 w-11/15 px-4" required minlength="6" placeholder="Repita a Senha" name="password_repeat"
